package com.enjoylottery.view.trendtype_11s5.style2;
...
public class MainTopView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawLine(gridWidth, 0, gridWidth, gridHeight * 2, mPaint);

        canvas.drawLine(gridWidth * 12, 0, gridWidth * 12, gridHeight * 2, mPaint);
        ...
        //写字
        canvas.drawText("任选分布图", rectF.centerX(), baseline, mPaint);
